...
//create a page using getX create view class,binding class and controller in view take column
//next two text next a row having drawer and a searchbar in search bar an icon as search 
//next hint as Search here... after that a text and than a gridview that gridview.builder will return a container
//having an image and after that container a text